          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-16">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold text-slate-900">Las Vegas, NV, United States</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-2 space-y-8 flex flex-col items-center md:items-start">
              <div className="p-6 bg-[#F8FAFC] border border-slate-100 rounded-3xl flex flex-col items-center text-center gap-4">
                ...
                <div>
                  <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest leading-tight">Officially Certified</p>
                  <p className="text-xs font-black text-[#007DBA]">HP GLOBAL PARTNER</p>
                </div>
              </div>
            </div>
